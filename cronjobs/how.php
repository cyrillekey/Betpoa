...
if ($err) {
    ...
    $sql="UPDATE odds_table set home_win=?,away_win=?,draw=?,onex=?,one2=?,X2=?,gg=?,ngg=?,dnb1=?,dnb2=?,ov25=?,ov35=?,ov15=?,ov05=?,un05=?,un15=?,un25=?
    ,un35=?,half1=?,halfX=?,half2=?,half1n1=?,half1n2=?
    ,half1nx=?,half2n1=?,half2n2=?,half2nx=?,halfxn1=?,halfxn2=?,halfxnx=?,win2nillhome_yes=?,win2nillhome_no=?,win2nillaway_yes=?,win2nillaway_no=? where fixture_id =?"; 
