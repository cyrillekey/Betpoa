        ...
        <div class="betslip-pick-container">
            ...
            while ($row = $stmt->fetch()) {
                ...
                if (
                    ...
                    ||($row->bet_value==7 && $row->total_goals < 1) ||($row->bet_value==8 && $row->total_goals > 1) ||($row->bet_value==9 && $row->total_goals >1) ||($row->bet_value==0 && $row->total_goals<2) ||($row->bet_value=="a" && $row->total_goals>2) ||($row->bet_value=="b" && $row->total_goals<3) ||($row->bet_value=="c" && $row->total_goals>3) ||($row->bet_value=="d" && $row->total_goals<4))  {
                        echo '<div class="betslip-pick">
